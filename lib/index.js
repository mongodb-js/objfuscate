...
var debug = require('debug')('objfuscate:parse-cmd');
...
module.exports = function() {
  ...
  if (cmd === '_main') {
    ...
    console.error('Unknown command "_main". See "objfuscate help" for available commands.');
    process.exit(1);
  }
  ...
  if (cmd === undefined) {
    ...
    try {
      ...
      console.error(format('Unknown command "%s". See "objfuscate help" for available commands.', cmd));
      process.exit(1);
    }
